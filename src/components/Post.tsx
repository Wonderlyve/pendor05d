...
import { Star, MessageCircle, Share2, ThumbsUp, Calendar, Clock, Trophy, MoreVertical, Bookmark, Award, UserPlus, CheckCircle, XCircle, X, Pencil, Trash } from 'lucide-react';
